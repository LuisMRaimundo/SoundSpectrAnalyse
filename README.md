...
- **Formula versioning** (Phase 7.1). `obs_w_formula_version = "v57_energy_anchored_occupancy"` and `density_formula_version = "v5_apply_density_metric_adapted_v6_1"` are exported on every row, permitting cross-version comparability of compiled workbooks.
