...
| `effective_partial_density` | `Density_Metrics` | Full-spectrum participation ratio (effective partial count over all bins) | $(\sum P)^2/\sum P^2$ | count | overall spectral richness | full-spectrum, includes residual |
